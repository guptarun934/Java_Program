...
public class MultiplicationMatrix {
    ...
    // Note that below variables are static i and j are used to know current cell of result matrix C[][]. k is used to know
    // current column number of A[][] and row number of B[][] to be multiplied
    public static int i = 0, j = 0, k = 0;

    static void multiplyMatrixRec (int row1, int col1, int A[][], int row2, int col2, int B[][], int C[][]) {
