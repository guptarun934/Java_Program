package Matrix;
// Java program to find median of a matrix sorted row wise
    ...
    static int binaryMedian (int m[][], int r, int c) {
        ...
        while (min < max) {
            ...
            for (int i = 0; i < r; ++i) {
                ...
                // the insertion point we can find elementsSmaller than the searched element by the following calculation
                if (get < 0)
                    get = Math.abs(get) - 1;
